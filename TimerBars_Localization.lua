...
if ( GetLocale() == "deDE" ) then
    ...
    TIMERBARS.BAR_TOOLTIP1 = "TimerBars";
    TIMERBARS.BAR_TOOLTIP2 = "Rechtsklick auf einen Balken für Einstellungen. Mehr Optionen sind im Blizzard Interface vorhanden. Zum Festsetzen und Aktivieren /timerbars, /tmb oder /tbs eingeben.";
...
elseif ( GetLocale() == "koKR" ) then
    ...
    TIMERBARS.UIPANEL_SUBTEXT2 = "바는 잠근 후? �작?�합니다. 풀렸? �때 바? �?�?�과 ?�기 조절, 그리고 ?�?�? �바? �우?�릭? �함으로? �설정? �하실 수 있습니다. '/timerbars', /tmb ?�는 '/tbs' 명령어를 통해서? �잠금/품 전환? �가능합니다.";
...
elseif ( GetLocale() == "ruRU" ) then
    -- by Vlakarados
    TIMERBARS.BAR_TOOLTIP1 = "TimerBars";
    TIMERBARS.BAR_TOOLTIP2 = "Клик правой кнопкой мыши по полосе для настройки. Больше настроек в Интерфейс / Модификации / TimerBars меню. Ввести /timerbars, /tmb или /tbs для блокировки и включения.";
    ...
    TIMERBARS.UIPANEL_SUBTEXT2 = "Полосы работают только когда заблокированы группы. Можно менять размер и перемещать группы полос и кликнуть правой кнопкой мыши для изменения индивидуальных настроек. Ввести '/timerbars', /tmb или '/tbs' to блокировки/разблокировки.";
...
elseif ( GetLocale() == "zhCN" ) then
    ...
    TIMERBARS.UIPANEL_SUBTEXT2 = "计时条锁定后才能正常工作. 当解锁时, 你可以移动或修改计时条分组的大小, 右键点击单独的计时条可以进行更多的设置. 你也可以输入 '/timerbars', /tmb 或 '/tbs' 来锁定/解锁.";
...
elseif ( GetLocale() == "zhTW" ) then
    ...
    TIMERBARS.UIPANEL_SUBTEXT2 = "計時條鎖定後才能正常工作. 當解鎖時, 妳可以移動或修改計時條分組的大小, 右鍵點擊單獨的計時條可以進行更多的設置. 妳也可以輸入 '/timerbars', /tmb 或 '/tbs' 來鎖定/解鎖.";
